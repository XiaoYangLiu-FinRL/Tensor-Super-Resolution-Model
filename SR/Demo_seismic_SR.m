...
overlap = 8 ;                    % the more overlap the better (patch size 5x5)
...
dataname = 'Testdata';
dataRoad = ['Data/Testing/' dataname];
% dataname = 'f3_p';
% dataRoad = ['Data/Training/' dataname];
load(dataRoad)
Testdata = Testdata(1:106,1:106,1:13);
...
%% super-resolution
% load dictionary
load('Dictionary/D2_512_0.03_9_5_double2.mat');
